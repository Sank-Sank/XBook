...
import sank.xbook.model.read_book.animation.PageAnimation;
import sank.xbook.model.read_book.animation.ScrollPageAnim;
import sank.xbook.model.read_book.animation.SimulationPageAnim;
import sank.xbook.model.read_book.animation.SlidePageAnim;
        ...
        switch (pageMode){
            ...
            case PAGE_MODE_SCROLL:
                mPageAnim = new ScrollPageAnim(mViewWidth, mViewHeight, 0,
                        ScreenUtils.dpToPx(NetPageLoad.DEFAULT_MARGIN_HEIGHT),this,mPageAnimListener);
                break;
            default:
                mPageAnim = new SimulationPageAnim(mViewWidth, mViewHeight,this,mPageAnimListener);
        }
